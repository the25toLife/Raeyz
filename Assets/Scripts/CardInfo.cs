...
public static class CardPool {
	...
	public static void associateCards () {
		...
		//
		//Arcangel
		Cards [25].associateCardInfo (Cards [26], CardRelation.LPAIR);
		Cards [26].associateCardInfo (Cards [25], CardRelation.RPAIR);
		//Earth Elemental
		Cards [90].associateCardInfo (Cards [91], CardRelation.LPAIR);
		Cards [91].associateCardInfo (Cards [90], CardRelation.RPAIR);
		//El'zorn
		Cards [95].associateCardInfo (Cards [96], CardRelation.RPAIR);
		Cards [96].associateCardInfo (Cards [95], CardRelation.LPAIR);
		//Enaus
		Cards [102].associateCardInfo (Cards [103], CardRelation.LPAIR);
		Cards [103].associateCardInfo (Cards [102], CardRelation.RPAIR);
		//Fire Elemental
		Cards [118].associateCardInfo (Cards [119], CardRelation.RPAIR);
		Cards [119].associateCardInfo (Cards [118], CardRelation.LPAIR);
		//Gruneath
		Cards [143].associateCardInfo (Cards [144], CardRelation.LPAIR);
		Cards [144].associateCardInfo (Cards [143], CardRelation.RPAIR);
		//Rudraskha
		Cards [283].associateCardInfo (Cards [284], CardRelation.LPAIR);
		Cards [284].associateCardInfo (Cards [283], CardRelation.RPAIR);
		//The Carrier
		Cards [329].associateCardInfo (Cards [330], CardRelation.LPAIR);
		Cards [330].associateCardInfo (Cards [329], CardRelation.RPAIR);
		//The Desecrator
		Cards [334].associateCardInfo (Cards [334], CardRelation.RPAIR);
		Cards [335].associateCardInfo (Cards [335], CardRelation.LPAIR);
		//Water Elemental
		Cards [377].associateCardInfo (Cards [378], CardRelation.RPAIR);
		Cards [378].associateCardInfo (Cards [377], CardRelation.LPAIR);
	}
}
